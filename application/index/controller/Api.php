...
class Api extends Controller{
    ...
    //商户号
    const MerCode = "207973";//"207973";"207575";
    //商户名
    const MerName = "广州堡庆网络科技有限公司";//"广州堡庆网络科技有限公司" 广州手上科技有限公司;

    const Account = "2079730012";//"2079730012";2075750014
            ...
            if($find){
                ...
                if($find['pay_status'] == 0 || $find['pay_status'] == 2 || $find['pay_status'] == 3){
                    ...
                    if($rspArray['trxstatus'] == '0000'){
                        ...
                        if($re){
                            $this->suppProOrder($find,session('promote_auth')['id']);
                        }
                    }else{
                        $msg = '待支付';
    ...
    //商户补单记录
    function suppProOrder($data,$id){
        if($data){
            $account = db('promote')->where('id',$id)->value('account');
