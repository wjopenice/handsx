            ...
            if($data){
                ...
                if($find){
                    ...
                    $ins_data = [
                        ...
                        'h5_wetch_revenue'  => $data['h5_wetch_revenue'],
                        'h5_alipay_revenue'  => $data['h5_alipay_revenue'],
                        'comm_revenue'  => $data['comm_revenue'],
                        'with_cycle'  => $data['with_cycle'],
                        'ident'    => $data['ident'],
                    ];
