<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"E:/phpStudy/WWW/hands/template/mobile\buss/list.html";i:1530164802;s:56:"E:/phpStudy/WWW/hands/template/mobile\common/header.html";i:1529896483;s:56:"E:/phpStudy/WWW/hands/template/mobile\common/footer.html";i:1530062767;s:58:"E:/phpStudy/WWW/hands/template/mobile\common/left_nav.html";i:1530164178;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="page">
            ...
            <div class="contentBox mescroll" id="mescroll">
                ...
                <div class="list-block">
                    <div class="list-container data-list" id="dataList"></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="/static/mobile/js/common/public.js"></script>
    ...
    <script>
        ...
        $(function(){
            ...
            /*加载列表数据  page = {num:1, size:10}; num:当前页 从1开始, size:每页数据条数 */
            ...
            function setListData(curPageData){
                for (var i = 0; i < curPageData.length; i++) {
                    ...
                    var pid = curPageData[i].id;
                    var str="<ul>" +
                        "<li>" +
                        "<a href='/mobile/buss/detail&id="+pid+"' external>" +
                        "<div class='item-content item-link'>" +
                        "<div class='item-media'>" +
                        "<i class='icon icon-f7'></i>" +
                        "</div>" +
                        "<div class='item-inner item-border'>" +
                        "<div class='item-title'>"+pd.account+"</div>" +
                        "</div>" +
                        "</div>" +
                        ...
                        "<div class='item-title item-time'>"+formatDate(pd.create_time)+"</div>" +
                        "<div class='item-after item-files'>"+pd.level+"</div>" +
                        "</div>" +
                        "</div>" +
                        "</a>" +
                        "</li>" +
