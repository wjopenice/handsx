<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"E:/phpStudy/WWW/hands/template/admin\fiels/index.html";i:1529567136;s:55:"E:/phpStudy/WWW/hands/template/admin\common/header.html";i:1529635016;s:53:"E:/phpStudy/WWW/hands/template/admin\common/memu.html";i:1529567136;}*/ ?>
...
<script type="text/javascript" src="/static/js/admin/fiels.js"></script>
<body>
<div id="pageAll">
    <div class="pageTop">
        <div >
            <img src="/static/index/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
                href="#">充值管理</a>&nbsp;-</span>&nbsp;文件列表
        </div>
    </div>
    ...
    <div id="content" style="width: 100%;">
        ...
        <table id="fiels" lay-filter="fiels"></table>
        <!-- balance 表格 显示 end-->

        <script type="text/html" id="barFiels">
