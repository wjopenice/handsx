<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:/phpStudy/WWW/hands/template/admin\administration/promote.html";i:1529979320;s:55:"E:/phpStudy/WWW/hands/template/admin\common/header.html";i:1529635016;s:53:"E:/phpStudy/WWW/hands/template/admin\common/memu.html";i:1529567136;}*/ ?>
...
<script type="text/javascript" src="/static/js/admin/promote.js"></script>


<script type="text/html" id="switchTpl">
    <!-- 这里的 checked 的状态只是演示 -->
    <input type="checkbox" name="status" id="status" data-id="{{d.id}}" value="{{d.status}}" lay-skin="switch" lay-text="正常|禁用" lay-filter="status" {{ d.status == 1 ? 'checked' : '' }}>
</script>
<body>
<div id="pageAll">
    <div class="pageTop">
    ...
    <div id="content" style="width: 100%;">
        <blockquote class="layui-elem-quote" style="height: 30px;">
            <form class="layui-form" style="float:right;width:100%">
                <button lay-filter="addpro" class="layui-btn" lay-submit><i class="fa fa-search" aria-hidden="true"></i> 添加</button>
        ...
        <table id="promote" lay-filter="promote"></table>
        <!-- balance 表格 显示 end-->
