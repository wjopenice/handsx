<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"E:/phpStudy/WWW/hands/template/mobile\gear/detail.html";i:1530001093;s:56:"E:/phpStudy/WWW/hands/template/mobile\common/header.html";i:1529896483;s:56:"E:/phpStudy/WWW/hands/template/mobile\common/footer.html";i:1529655377;s:58:"E:/phpStudy/WWW/hands/template/mobile\common/left_nav.html";i:1530000345;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<link rel="stylesheet" href="/static/mobile/css/common/detail.css">
    <div class="page-group">
        <div class="page">
            ...
            <div class="content">
                <!-- 面包屑 -->
                <div class="crumbs"><a href="javascript:void(0);">档位管理&nbsp;>&nbsp;</a><a href="javascript:void(0);" onClick="javascript :history.back(-1);" external>档位设置 ✕</a></div>
                <form action="/mobile/gear/detail?id=<?php echo $data['id']; ?>" method="post">
                    ...
                    <ul>
                        <li class="item-content">
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-after"><input class="item-order" type="text" name="level" value="<?php echo $data['level']; ?>"></div>
                            </div>
                        </li>
                        <li class="item-content item-link">
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-after"><input class="item-order" type="text" name="revenue" value="<?php echo $data['revenue']; ?>"></div>
                            </div>
                        </li>
                        <li class="item-content item-link">
                            <div class="item-media"><i class="icon icon-f7"></i></div>
                            <div class="item-inner">
                                ...
                                <div class="item-after"><input class="item-order" type="text" name="h5_alipay_revenue" value="<?php echo $data['h5_alipay_revenue']; ?>"></div>
                            </div>
                        </li>
                        <li class="item-content item-link">
                            <div class="item-media"><i class="icon icon-f7"></i></div>
                            <div class="item-inner">
                                ...
                                <div class="item-after"><input class="item-order" type="text" name="h5_wetch_revenue" value="<?php echo $data['h5_wetch_revenue']; ?>"></div>
                            </div>
                        </li>
                        <li class="item-content item-link">
                            <div class="item-media"><i class="icon icon-f7"></i></div>
                            <div class="item-inner">
                                ...
                                <div class="item-after"><input class="item-order" type="text" name="comm_revenue" value="<?php echo $data['comm_revenue']; ?>"></div>
                            </div>
                        </li>
                        <li class="item-content item-link">
                            <div class="item-media"><i class="icon icon-f7"></i></div>
                            <div class="item-inner">
                                ...
                                <div class="item-after"><input class="item-order" type="text" name="with_cycle" value="<?php echo $data['with_cycle']; ?>"></div>
                            </div>
                        </li>
                    </ul>
                </div>
