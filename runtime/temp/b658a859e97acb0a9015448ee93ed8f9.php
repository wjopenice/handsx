<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"E:/phpStudy/WWW/hands/template/mobile\gear/list.html";i:1529998290;s:56:"E:/phpStudy/WWW/hands/template/mobile\common/header.html";i:1529896483;s:56:"E:/phpStudy/WWW/hands/template/mobile\common/footer.html";i:1529655377;s:58:"E:/phpStudy/WWW/hands/template/mobile\common/left_nav.html";i:1530000345;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <div class="content">
                ...
                <div class="list-block">
                    ...
                    <ul class="item-delete pr">
                        <li>
                            <a href="/mobile/gear/detail?id=<?php echo $value['id']; ?>" external>
                                <div class="item-content item-link">
                                    <div class="item-media"><i class="icon icon-f7"></i></div>
                                    <div class="item-inner item-border">
                                        <div class="item-title"><?php echo $value['level']; ?></div>
                                    </div>
                                </div>
                                <div class="item-content">
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-after item-files"><?php echo $value['comm_revenue']; ?></div>
                                    </div>
                                </div>
                            </a>
                        </li>
