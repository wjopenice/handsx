<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"E:/phpStudy/WWW/hands/template/admin\substitute/index.html";i:1529567136;s:55:"E:/phpStudy/WWW/hands/template/admin\common/header.html";i:1529635016;s:53:"E:/phpStudy/WWW/hands/template/admin\common/memu.html";i:1529567136;}*/ ?>
...
<script type="text/javascript" src="/static/js/admin/subst.js"></script>
            ...
            <form class="layui-form" style="float:right;width:100%">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="start" id="start" placeholder="提现申请开始时间">
                    </div>
                </div>
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="end" id="end" placeholder="提现申请结束时间">
                    </div>
                </div>
